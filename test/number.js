...
describe('Number', function () {
  ...
  it('should validate integer right', function () {
    ...
    const v = vjs.number({decimalPlace: 0});
  ...
  it('should validate float number with decimalPlace right', function () {
    const v = vjs.number({decimalPlace: 2});
